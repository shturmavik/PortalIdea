...
// const stateCategory = {
//     getDataIdeas,
//     getCategory:  async (href) =>  await currentAPI.getCategory(href)
// }

const TileIdeas = (props) => {
    const { dataIdeas } = props

    console.log(dataIdeas)
  return (
    <>
      {dataIdeas.categories.map((IMockCategories) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Link to={hrefIdea}>
                      ...
                      <div className='font-bold px-7 text-sm tile-list__item-more relative'>
                        Подробнее
                      </div>
                    </Link>
                    <Tag tags={IMockIdeas.tag} />
                    <div className='bg-blue-500 flex tile-list__item-footer items-center justify-between px-7 rounded-b-2xl'>
